...
export const authUser = (id, username, role, img, token, success) => (dispatch) => {
    try {
        ...
        dispatch({ type: AUTHORIZATION, payload: { id: null, username: null,firstName: null, lastName: null, email: null, role: null, img: null, token: null, success: false, github: null, twitter: null,
            instagram: null, facebook: null, users: null } });
    }
}
...
export const getUserById = (firstName, lastName, email, github, twitter, instagram, facebook) => dispatch => {
    try {
        ...
        dispatch({ type: GET_USER_DATA, payload: { firstName: null, lastName: null, email: null, github: null, twitter: null, instagram: null, facebook: null } })
    }
}
